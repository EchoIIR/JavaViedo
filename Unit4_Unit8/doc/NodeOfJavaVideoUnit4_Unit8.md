...
- [五、常用对象API(SE15-SE20)](#五-常用对象apise15-se20)
  ...
  - [5.4 StringBuilder类](#54-stringbuilder类)
    ...
    - [5.4.3 补充：JDK升级的原因](#543-补充jdk升级的原因)
      ...
      - [2、提高效率](#2-提高效率)
      - [3、增加安全性](#3-增加安全性)
  - [5.5 集合框架：Collection和Map](#55-集合框架collection和map)
    - [5.5.1 集合框架的概述](#551-集合框架的概述)
    - [5.5.2 集合框架分类](#552-集合框架分类)
      - [1、集合框架的构成与分类](#1-集合框架的构成与分类)
      - [2、Collection和Map的区别](#2-collection和map的区别)
    - [5.5.2 Collection](#552-collection)
      - [1、Collection的方法](#1-collection的方法)
      - [2、补充：迭代器的原理](#2-补充迭代器的原理)
    - [5.5.2 Collection之List](#552-collection之list)
      - [3、List特点](#3-list特点)
      - [4、List方法](#4-list方法)
      - [5、迭代器在List中的使用](#5-迭代器在list中的使用)
      - [6、List的迭代器的练习：用listIterator实现在迭代器中对列表增删改查](#6-list的迭代器的练习用listiterator实现在迭代器中对列表增删改查)
    ...
    - [5.5.3 Collection之Set接口](#553-collection之set接口)
      - [1、Set特点](#1-set特点)
      - [2、Set方法](#2-set方法)
      - [3、Set的两个常用子类HashSet,TreeSet](#3-set的两个常用子类hashsettreeset)
        - [1、Set之HashSet](#1-set之hashset)
        - [2、Set之TreeSet](#2-set之treeset)
    - [5.5.4 Collection的List与Set小结](#554-collection的list与set小结)
    - [5.5.6、Map<K,V>](#556-mapkv)
      - [1、Map概述](#1-map概述)
      - [2、Map的常用子类](#2-map的常用子类)
        - [Map之Hashtable](#map之hashtable)
        - [Map之HashMap](#map之hashmap)
        - [Map之TreeMap](#map之treemap)
  - [5.6 泛型](#56-泛型)
    - [5.6.1 泛型的概述](#561-泛型的概述)
    - [5.6.2 集合之泛型类](#562-集合之泛型类)
      - [1、泛型自定义类的演示](#1-泛型自定义类的演示)
      - [2、泛型通配符:GenericDefineDemo5.java](#2-泛型通配符genericdefinedemo5java)
  - [5.7 其他工具](#57-其他工具)
    - [5.7.1 forEach语句(高级for)](#571-foreach语句高级for)
    - [5.7.2 函数可变参数](#572-函数可变参数)
    - [5.7.3 静态导入](#573-静态导入)
...
## 5.7 其他工具
### 5.7.1 forEach语句(高级for)
![](images/foreach语句.png)
**传统for和高级for的区别**
![](images/传统for和高级for的区别.png)
